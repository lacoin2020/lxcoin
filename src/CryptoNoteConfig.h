...
namespace parameters {
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "lx-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "lx-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "lx-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "lx-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "lx-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "lx-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "lx-miner_conf.json";
  } // parameters
...
const char     CRYPTONOTE_NAME[]                             = "lxcoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001904e029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101901a28140520dd716130367169aa5b6ac92bdbc501c477ce0c2263f2cae8ea92";
...
const std::initializer_list<const char*> SEED_NODES = {
   "194.182.70.106:17236",
   "80.211.213.150:17236"
};
